      ...
      <div class="modal-header">
        ...
        <form action="/save-units" method="POST">
          ...
          <div class="modal-body">
              ...
              <div class="form-group">
                <label for="message-text" name="course_unit" class="col-form-label">Unit:</label>
                <textarea name="course_unit" class="form-control" id="message-text"></textarea>
              </div>
          </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('units/'.$datum->id) }}" class="btn btn-success">EDIT</a>
                        </td>
                        <td>
